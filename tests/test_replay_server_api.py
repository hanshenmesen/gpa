...
class ReplayServerApiTests(unittest.TestCase):
    ...
    def test_replay_manifest_intent_and_space_endpoints(self):
        ...
        self.assertIn("Visual QA v11", product_css)
        self.assertIn(".catalog-search-icon::before", product_css)
        self.assertIn(".drop-icon::before", product_css)
        self.assertIn("text-wrap: balance", product_css)
