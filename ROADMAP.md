...
The roadmap is outcome-based. Dates are intentionally avoided until real user
evidence establishes the work required.

## Now — public technical preview
...
## Later — signed end-user distribution
...
- unattended remote desktop authority;
- arbitrary shell execution from community packages;
- guaranteed compatibility across applications or operating systems;
- uploading raw screens, sessions or credentials by default.

Propose or vote on outcomes in GitHub Discussions. Submit real tasks through the
Real-world workflow Issue form so roadmap decisions remain evidence-based.
